...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
    ...
    if(!isPasswordCorrect){
        throw new ApiError(400,"Imvalid Password");
    }
...
const getCurrentUser = asyncHandler(async (req,res)=>{
    return  res
    .status(200).json(200,req.user, "current user fetched successfully")
})
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    if(!coverImage){
        return new ApiError(400,"Error while uploading coverImage")
    }
